...
/**
 * @see https://github.com/Tinkoff/investAPI/blob/main/src/docs/errors/api_errors.json
 */
export const apiErrors: Record<string, ApiError> = {
  '30001': {
    ...
    description:
      'Входной параметр *from* является обязательным. </br> Укажите корректный параметр *from*.',
  },
  '30002': {
  ...
  '30003': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *from* не может быть меньше текущей даты. </br> Укажите корректный параметр *from*.',
  },
  '30004': {
    message: "missing parameter: 'to'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *to* является обязательным. </br> Укажите корректный параметр *to*.',
  },
  '30005': {
    message: "'id_type' is invalid",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *id_type* имеет некорректное значение.</br>Список доступных значений: [*id_type*](https://tinkoff.github.io/investAPI/instruments#instrumentidtype).',
  },
  '30006': {
    message: "missing parameter: 'id_type'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *id_type* является обязательным. </br> Укажите корректный параметр *id_type*.',
  },
  '30007': {
    message: "missing parameter: 'id'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *id* является обязательным. </br> Укажите корректный параметр *id*.',
  },
  '30008': {
    message: "missing parameter: 'figi'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *figi* является обязательным. </br> Укажите корректный параметр *figi*.',
  },
  '30009': {
    message: "'from' is invalid",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *from* имеет некорректное значение.</br>Укажите корректный параметр *from*.',
  },
  '30010': {
    message: "'to' is invalid",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *to* имеет некорректное значение.</br>Укажите корректный параметр *to*.',
  },
  '30011': {
    message: 'interval is invalid',
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *interval* имеет некорректное значение.</br>Список доступных значений: [*interval*](https://tinkoff.github.io/investAPI/marketdata#subscriptioninterval).',
  },
  '30012': {
  ...
  '30013': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *class_code* не может быть пустым при поиске по тикеру. </br>Укажите корректный параметр *class_code*. </br>Подробнее: [Идентификация инструментов](https://tinkoff.github.io/investAPI/faq_identification/).',
  },
  '30014': {
    message: 'the maximum request period for the given candle interval has been exceeded',
    type: 'INVALID_ARGUMENT',
    description:
      'Превышен максимальный период запроса для данного интервала свечи. </br>Укажите корректный интервал.',
  },
  '30015': {
    message: "missing parameter: 'quantity'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *quantity* является обязательным. </br> Укажите корректный параметр *quantity*.',
  },
  '30016': {
    message: "'quantity' is invalid",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *quantity* имеет некорректное значение.</br>Укажите корректный параметр *quantity*.',
  },
  '30017': {
    message: "missing parameter: 'price'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *price* является обязательным. </br> Укажите корректный параметр *price*.',
  },
  '30018': {
    message: 'price is invalid',
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *price* имеет некорректное значение.</br>Укажите корректный параметр *price*.',
  },
  '30019': {
    message: "missing parameter: 'direction'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *direction* является обязательным. </br> Укажите корректный параметр *direction*.',
  },
  '30020': {
    message: "'direction' is invalid",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *direction* имеет некорректное значение.</br>Список доступных значений: [*direction*](https://tinkoff.github.io/investAPI/stoporders/#stoporderdirection).',
  },
  '30021': {
    message: "missing parameter: 'account_id'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *account_id* является обязательным. </br> Укажите корректный параметр *account_id*.',
  },
  '30025': {
    message: "missing parameter: 'order_type'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *order_type* является обязательным. </br> Укажите корректный параметр *order_type*.',
  },
  '30027': {
    message: "missing parameter: 'order_id'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *order_id* является обязательным. </br> Укажите корректный параметр *order_id*.',
  },
  '30031': {
    message: "missing parameter: 'depth'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *depth* является обязательным. </br>Укажите корректный параметр *depth*.',
  },
  '30032': {
    message: 'depth is invalid',
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *depth* имеет некорректное значение.</br>Укажите корректный параметр *depth*.',
  },
  '30033': {
  ...
  '30034': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Недостаточно средств для совершения сделки (ошибка песочницы). </br>Пополните баланс нужной валюты.',
  },
  '30036': {
    message: "missing parameter: 'stop_price'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *stop_price* является обязательным. </br>Укажите корректный параметр *stop_price*.',
  },
  '30037': {
  ...
  '30038': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *stop_order_type* имеет некорректное значение.</br>Список доступных значений: [*stop_order_type*](https://tinkoff.github.io/investAPI/stoporders/#stopordertype).',
  },
  '30040': {
  ...
  '30042': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Недостаточно активов для маржинальной сделки. </br>Проверьте маржинальные показатели счёта.',
  },
  '30043': {
  ...
  '30044': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *expiration_type* имеет некорректное значение.</br>Список доступных значений: [*expiration_type*](https://tinkoff.github.io/investAPI/stoporders/#stoporderexpirationtype).',
  },
  '30045': {
    message: "missing parameter: 'ticker'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *ticker* является обязательным. </br>Укажите корректный параметр *ticker*.',
  },
  '30047': {
    message: 'price currency does not match the settlement currency',
    type: 'INVALID_ARGUMENT',
    description:
      'Валюта цены не совпадает с валютой расчётов по инструменту. </br>Укажите корректную валюту цены.',
  },
  '30048': {
  ...
  '30050': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *instrument_status* имеет некорректное значение.</br>Список доступных значений: [*instrument_status*](https://tinkoff.github.io/investAPI/instruments#instrumentstatus).',
  },
  '30051': {
  ...
  '30065': {
    ...
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *task_id* является обязательным. </br> Укажите корректный параметр *task_id*.',
  },
  '30066': {
    message: "missing parameter: 'payload'",
    type: 'INVALID_ARGUMENT',
    description:
      'Входной параметр *payload* является обязательным. </br> Укажите корректный параметр *payload*.',
  },
  '30067': {
  ...
  '40002': {
    ...
    description:
      'Недостаточно прав для совершения операции. </br>Токен доступа имеет уровень прав read-only.</br>Подробнее: [Виды токенов](https://tinkoff.github.io/investAPI/index#_2)',
  },
  '50001': {
    message: 'exchange not found',
    type: 'NOT_FOUND',
    description:
      'Биржа не найдена по переданному *exchange_id*.</br>Укажите корректный *exchange_id*.',
  },
  '50002': {
  ...
  '50005': {
    ...
    type: 'NOT_FOUND',
    description:
      'Торговое поручение не найдено по переданному *order_id*.</br>Укажите корректный *order_id*.',
  },
  '50006': {
    message: 'stop-order not found',
    type: 'NOT_FOUND',
    description:
      'Стоп-заявка не найдена по переданному *stop_order_id*.</br>Укажите корректный *stop_order_id*.',
  },
  '50007': {
  ...
  '70001': {
    ...
    type: 'INTERNAL',
    description:
      'Внутренняя ошибка сервиса.</br>Если ошибка повторяется, обратитесь в службу технической поддержки.',
  },
  '70002': {
